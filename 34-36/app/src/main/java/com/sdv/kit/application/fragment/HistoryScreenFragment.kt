...
import com.sdv.kit.application.viewmodel.HistoryViewModel

class HistoryScreenFragment : Fragment(R.layout.fragment_history_screen) {
    private lateinit var logoutButton: TextView
    private lateinit var recyclerView: RecyclerView
    private lateinit var placesLoadingProgressBar: ProgressBar

    private var viewModel: HistoryViewModel? = null
    private val placesAdapter: PlacesAdapter by lazy { PlacesAdapter(requireContext()) }
